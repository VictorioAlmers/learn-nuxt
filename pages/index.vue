  ...
  <div>
    ...
    <main class="mb-16">
      ...
      <section class="mt-10 lg:px-desktop">
        <!-- class agar ada divider di tengah -->
        <div class="flex divide-x divide-dashed">
          ...
          <div class="flex items-center justify-evenly space-x-10 basis-1/2">
            <div class="text-center relative">
              <div 
                class="absolute left-0 top-0 rounded-full w-20 h-20 bg-green-400/50 ">
              </div>
            ...
            <div class="text-center relative">
              <div 
                class="absolute left-0 top-0 rounded-full w-20 h-20 bg-yellow-400/50">
              </div>
